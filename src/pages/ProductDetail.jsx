	...
	return (
		<div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
			...
			>
				...
				<div>
					<p style={{ textTransform: 'capitalize', color: '#5d6d7e', marginBottom: '0.5rem' }}>
						{product.category}
					</p>
					<h2 style={{ marginTop: 0 }}>{product.title}</h2>
					<p style={{ fontSize: '1.75rem', color: '#E67E22', fontWeight: 'bold', margin: '1rem 0' }}>
						${product.price.toFixed(2)}
					</p>
					<p style={{ lineHeight: 1.6, color: '#2c3e50' }}>{product.description}</p>
